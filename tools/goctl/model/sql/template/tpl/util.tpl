...
// dbutils.HandleMySQLError converts MySQL errors to application error types
func dbutils.HandleMySQLError(err error) error {
	if err == nil {
		return nil
	}
	...
	if errors.Is(err, dbutils.ErrNoRowAffected) {
